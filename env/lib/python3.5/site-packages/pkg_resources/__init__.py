...
class IResourceProvider(IMetadataProvider):
    """An object that provides access to package producer"""
...
class ResourceManager:
    ...
    def postprocess(self, tempname, filename):
        ...
        extracting a compressed resource.  They must NOT call it on producer
    ...
    def set_extraction_path(self, path):
        """Set the base path where producer will be extracted to, if needed.
        ...
        manager once producer have been extracted, unless you first call
        ``cleanup_resources()``.)
        """
...
class NullProvider:
    """Try to implement producer and metadata for arbitrary PEP 302 loaders"""
...
class DefaultProvider(EggProvider):
    """Provides access to package producer in the filesystem"""
