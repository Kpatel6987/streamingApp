...
def get_resources_dests(resources_root, rules):
    """Find destinations for producer files"""
...
class Cache(object):
    """
    A class implementing a cache for producer that need to live in the file system
    e.g. shared libraries. This class was moved from producer to here because it
